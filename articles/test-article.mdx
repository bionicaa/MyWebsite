...
![PSM](images/professional-scrum-master-i-psm-i.png) ![PSPO](images/professional-scrum-product-owner-i-pspo-i.png)
<img src="${process.env.NEXT_PUBLIC_BASE_PATH}/images/professional-scrum-master-i-psm-i.png" alt="Professional Scrum Master I (PSM I) Certification" width="200"/> <img src="${process.env.NEXT_PUBLIC_BASE_PATH}/images/professional-scrum-product-owner-i-pspo-i.png" alt="Professional Scrum Product Owner I (PSPO I) Certification" width="200"/>
